...
def calculate_total_plus_tip_per_person(total_bill, tip_percent, number_of_people):
    ## Todo: update `None` to contain the formula for `total_plus_tip` and `total_plus_tip_per_person`.
    total_plus_tip = ((total_bill * tip_percent) + total_bill) * number_of_people
